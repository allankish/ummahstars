<div class="wrapper-section home-7-10-bg">
    ...
    <div class="left-slide-menu">
        ...
        <ul class="left-slide-menu-list">
            <li><a href="#" class="home-btn-left brown-btn-left">CHARACTERS</a></li>
            <li><a href="#" class="home-btn-left brown-btn-left">DEED BANK</a></li>
    ...
    <div class="right-side-section">
        <div class="read-more"><a href="#"><img src="<?php echo base_url(); ?>assets/front/images/7-10_read-more.png" alt="read-more-img"/></a></div>
        <ul class="right-slide-menu-list">
            <li><a href="#" class="home-btn-right brown-btn-right">What is Islaam?</a></li>
            <li><a href="#" class="home-btn-right brown-btn-right">Islaamic History</a></li>
            <li><a href="#" class="home-btn-right brown-btn-right">Quraan And Arabic</a></li>
            <li><a href="#" class="home-btn-right brown-btn-right">Islaamic Morals</a></li>
            <li><a href="#" class="home-btn-right brown-btn-right">Islaamic Etiquettes</a></li>
        </ul>
    </div>
