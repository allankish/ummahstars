<div class="wrapper-section home-4-6-bg">
    ...
    <div class="left-slide-menu">
        ...
        <ul class="left-slide-menu-list">
            ...
            <li><a href="<?php echo base_url(); ?>" class="home-btn-left blue-btn-left">LOG OFF</a></li>
        </ul>
    </div>
    ...
    <div class="right-side-section">
        ...
        <ul class="right-slide-menu-list">
            ...
            <li><a href="#" class="home-btn-right blue-btn-right">Islaamic Etiquettes</a></li>
        </ul>
    </div>
