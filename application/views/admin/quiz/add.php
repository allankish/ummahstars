                    ...
                    <form role="form" name="quiz_form" action="<?php echo base_url(); ?>usadmin/quiz/add" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group col-xs-9">
                                ...
                                <input type="text" class="form-control" id="quiz_title" name="quiz_title" value="<?php echo $this->session->flashdata('quiz_title') ?>" placeholder="Enter Quiz Title">
                           </div>
                            <div class="form-group col-xs-9">
                                <label>Section</label>
                                <select class="form-control" id="section_id" name="section_id">
                                    ...
                                    <option value="<?php echo $section['section_id'];?>" <?php if($this->session->flashdata('section_id') == $section['section_id']) echo 'selected' ?>><?php echo $section['section_name'];?></option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <input type="hidden" id="category_old_value" name="category_old_value" value="<?php echo $this->session->flashdata('category_id') ?>"/>
                            ...
                            <div class="form-group col-xs-9">
                                ...
                                <select class="form-control" id="age_group_id" name="age_group_id">
                                    ...
                                    <option value="<?php echo $age_group['age_group_id'];?>" <?php if($this->session->flashdata('age_group_id') == $age_group['age_group_id']) echo 'selected' ?>><?php echo $age_group['age_group_name'];?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                           ...
                           <div class="form-group col-xs-9">
                                ...
                                <input type="text" class="form-control" id="deed" name="deed" value="<?php echo $this->session->flashdata('deed') ?>" placeholder="Enter Number of Deeds">
                           </div>
                            
                           <div class="form-group col-xs-9">
                                <label for="no_questions">Number of Questions</label>
                                <input type="text" class="form-control" id="no_questions" name="no_questions" value="<?php echo $this->session->flashdata('no_questions') ?>" placeholder="Enter Number of Questions">
                           </div>
