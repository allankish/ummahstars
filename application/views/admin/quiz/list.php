                            ...
                            <tbody>
                               ...
                               ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url().'usadmin/quiz/edit/'. $quiz['quiz_id']?>">Edit</a> | <a class="delete_quiz" href="<?php echo base_url().'usadmin/quiz/delete/'. $quiz['quiz_id']?>">Delete</a></td>
